...
$wp_customize->add_control( 
    ...
    array(
        ...
        'label'         => esc_html__('Layout version', 'cerax'),

        'choices'   => array(

            'wide'           =>  esc_html__('Wide','cerax'),

            'boxed'         =>   esc_html__('Boxed','cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Body Background Color', 'cerax'),
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Content Box Controls (px)', 'cerax' ),
...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Page Sidebar Position', 'cerax'),
