...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'description'   => esc_html__(' Opacity =1 for Background Color', 'cerax'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Header Background Bottom', 'cerax'),

            'description'   => esc_html__('Only Style Header 02', 'cerax'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Sticky Header Background', 'cerax'),
...
$wp_customize->add_control( new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Sticky Header Color Menu', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('Menu color', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('Menu Hover', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('Menu Active', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Hover & Active', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Background', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Background Hover & Active', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Border Line', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Child color', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Child Hover & Active', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Child Background', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label' => esc_html__('SubMenu Child Background Hover & Active', 'cerax'),
