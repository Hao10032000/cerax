...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Text Color', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Link Color Hover', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Message Text Color', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Message Link Color', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Message Link Color Hover', 'cerax'),
