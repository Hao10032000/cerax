...
$wp_customize->add_control( 
    ...
    array (
        ...
        'label'         => esc_html__('Blog Layout', 'cerax'),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Post Grid Columns', 'cerax'),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Post Per Page', 'cerax'),
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        ...
        'label'     => esc_html__('Post Content Elements', 'cerax'),

        'description' => esc_html__( 'Drag and drop elements to re-order.', 'cerax' ),
        ...
        'choices' => array(
            ...
            'meta'            => esc_html__( 'Meta', 'cerax' ),

            'title'           => esc_html__( 'Title', 'cerax' ),

            'excerpt_content' => esc_html__( 'Excerpt', 'cerax' ),

            'readmore'        => esc_html__( 'Read More', 'cerax' ),
...
$wp_customize->add_control(
    ...
    array(
        ...
        'label'     => esc_html__('Read More Text', 'cerax'),
...
$wp_customize->add_control( new themesflat_Control_Drag_And_Drop( $wp_customize,
    ...
    array(
        ...
        'label'     => esc_html__('Meta Elements', 'cerax'),
        ...
        'choices' => array(
            ...
            'comment'   => esc_html__( 'Comment', 'cerax' ),

             'category'  => esc_html__( 'Category', 'cerax' ),
...
$wp_customize->add_control( 
    ...
    array(
        ...
        'label'         => esc_html__('Pagination Style', 'cerax'),

        'choices'   => array(

            'pager'     => esc_html__('Page','cerax'),

            'numeric'         =>  esc_html__('Numeric','cerax'),

            'pager-numeric'         =>  esc_html__('Page & Numeric','cerax'),
