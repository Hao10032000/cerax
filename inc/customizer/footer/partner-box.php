...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
        ...
        array(
            ...
            'label'     => esc_html__('Partner Box ( OFF | ON )', 'cerax'),
...
$wp_customize->add_control(
    ...
    new themesflat_MultiImages(
        ...
        array(
           ...
           'label'          => esc_html__( 'Upload Your Partner Image', 'cerax' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Desktop)', 'cerax' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Tablet)', 'cerax' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Show Number Image (Mobile)', 'cerax' ),
...
$wp_customize->add_control(
    ...
    array(
       ...
       'label'          => esc_html__( 'Gap Image', 'cerax' ),
...
$wp_customize->add_control( new themesflat_BoxControls($wp_customize,
    ...
    array(
        ...
        'label' => esc_html__( 'Partner Box Controls (px)', 'cerax' ),
...
$wp_customize->add_control( 
    ...
    new themesflat_ColorOverlay(
        ...
        array(
            ...
            'label'         => esc_html__('Partner Box Backgound', 'cerax'),
