...
function themesflat_customize_register( $wp_customize ) {
   ...
   //___FOOTER___//
    ...
    $wp_customize->get_section( 'background_image' )->title = esc_html__('Layout Style', 'cerax');
...
function themesflat_sanitize_bg_size( $input ) {
    ...
    $valid = array(
        ...
        'cover'     => esc_html__('Cover', 'cerax'),

        'contain'   => esc_html__('Contain', 'cerax'),
...
function themesflat_sanitize_blog( $input ) {
    ...
    $valid = array(
        ...
        'fullwidth'  => esc_html__( 'Full width (no sidebar)', 'cerax' )
...
function themesflat_sanitize_pagination ( $input ) {
    ...
    $valid = array(
        ...
        'pager' => esc_html__('Pager', 'cerax'),

        'numeric' => esc_html__('Numeric', 'cerax'),

        'page_numeric' => esc_html__('Pager & Numeric', 'cerax')                
...
function themesflat_sanitize_related_post ( $input ) {
    ...
    $valid = array(
        ...
        'simple_list' => esc_html__('Simple List', 'cerax'),

        'grid' => esc_html__('Grid', 'cerax')        
...
function themesflat_sanitize_fw( $input ) {
    ...
    $valid = array(
        ...
        '0' => esc_html__('footer_default', 'cerax'),

        '1' => esc_html__('One', 'cerax'),

        '2' => esc_html__('Two', 'cerax'),

        '3' => esc_html__('Three', 'cerax'),

        '4' => esc_html__('Four', 'cerax')
...
function themesflat_sanitize_related_portfolio( $input ) {
    ...
    $valid = array(
        ...
        'grid_masonry'         => esc_html__( 'Grid Masonry', 'cerax' ),

        'grid_nomargin'        => esc_html__( 'Grid Masonry No Margin', 'cerax' ),

        'carosuel'             => esc_html__( 'Carosuel', 'cerax' ),

        'carosuel_nomargin'    => esc_html__( 'Carosuel No Margin', 'cerax' )       
...
function themesflat_sanitize_portfolio_pagination( $input ) {
    ...
    $valid = array(
        ...
        'load_more'         => esc_html__( 'Load More', 'cerax' )     
...
function themesflat_sanitize_portfolio_order( $input ) {
    ...
    $valid = array(
        ...
        'date'          => esc_html__( 'Date', 'cerax' ),

        'id'            => esc_html__( 'Id', 'cerax' ),

        'author'        => esc_html__( 'Author', 'cerax' ),

        'title'         => esc_html__( 'Title', 'cerax' ),

        'modified'      => esc_html__( 'Modified', 'cerax' ),

        'comment_count' => esc_html__( 'Comment Count', 'cerax' ),

        'menu_order'    => esc_html__( 'Menu Order', 'cerax' )     
...
function themesflat_sanitize_portfolio_order_direction( $input ) {
    ...
    $valid = array(
        ...
        'DESC' => esc_html__( 'Descending', 'cerax' ),

        'ASC'  => esc_html__( 'Assending', 'cerax' )       
...
function themesflat_sanitize_grid_portfolio( $input ) {
    ...
    $valid = array(
        ...
        'portfolio-two-columns'     => esc_html__( '2 Columns', 'cerax' ),

        'portfolio-three-columns'     => esc_html__( '3 Columns', 'cerax' ),

        'portfolio-four-columns'     => esc_html__( '4 Columns', 'cerax' ),

        'portfolio-five-columns'     => esc_html__( '5 Columns', 'cerax' )
...
function themesflat_sanitize_grid_portfolio_related( $input ) {
    ...
    $valid = array(
        ...
        'portfolio-one-columns'     => esc_html__( '1 Columns', 'cerax' ),
...
function themesflat_sanitize_layout_product( $input ) {
    ...
    $valid = array(        
        ...
        'fullwidth'         => esc_html__( 'No Sidebar', 'cerax' ),
