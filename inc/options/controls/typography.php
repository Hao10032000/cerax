	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			...
			$this->titles = array(
				...
				'100'        => esc_html__( 'Thin 100', 'cerax' ),

				'100italic'  => esc_html__( 'Thin 100 italic', 'cerax' ),

				'200'        => esc_html__( 'Extra-light 200', 'cerax' ),

				'200italic'  => esc_html__( 'Extra-light 200 italic', 'cerax' ),

				'300'        => esc_html__( 'Light 300', 'cerax' ),

				'300italic'  => esc_html__( 'Light 300 italic', 'cerax' ),

				'400'        => esc_html__( 'Normal 400', 'cerax' ),

				'400italic'  => esc_html__( 'Normal 400 italic', 'cerax' ),

				'regular'    => esc_html__( 'Normal 400', 'cerax' ),

				'italic'     => esc_html__( 'Normal 400 italic', 'cerax' ),

				'500'        => esc_html__( 'Medium 500', 'cerax' ),

				'500italic'  => esc_html__( 'Medium 500 italic', 'cerax' ),

				'600'        => esc_html__( 'Semi-bold 600', 'cerax' ),

				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'cerax' ),

				'700'        => esc_html__( 'Bold 700', 'cerax' ),

				'700italic'  => esc_html__( 'Bold 700 italic', 'cerax' ),

				'800'        => esc_html__( 'Extra-bold 800', 'cerax' ),

				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'cerax' ),

				'900'        => esc_html__( 'Ultra-bold 900', 'cerax' ),

				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'cerax' )
			...
			$this->titles_subsets = array(
				...
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'cerax'),

			    "greek" 		=> esc_html__("Greek",'cerax'),

			    "greek-ext"		=>	esc_html__("Greek Extended",'cerax'),

			    "latin-ext"		=>	esc_html__("Latin Extended",'cerax'),

			    "cyrillic"		=>	esc_html__("Cyrillic",'cerax'),

			    "vietnamese"	=>	esc_html__("Vietnamese",'cerax'),

			    "latin" 		=> esc_html__("Latin",'cerax')
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'cerax' ) ?></label>
					...
					<div class="themesflat-options-control-inputs">
						...
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							...
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'cerax' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label><?php esc_html_e( 'Font Weight & Style', 'cerax' ) ?></label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					...
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						...
						<div class="themesflat-options-control-title customize-control-title">
							...
							<label><?php esc_html_e( 'Font subsets', 'cerax' ) ?></label>
				...
				<div class="themesflat-typography-group typography-size">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'cerax' ) ?></label>
				...
				<div class="themesflat-typography-group typography-line_height">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'cerax' ) ?></label>
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'cerax' ) ?></label>
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					...
					<div class="themesflat-options-control-title customize-control-title">
						...
						<label><?php esc_html_e( 'Font Color', 'cerax' ) ?></label>
