...
class sidebar_manager {
	...
	public static function add_sidebar() {
		...
		if ( ! $name || $name == 'null' ) {
			...
			die( "alert('".esc_html__( 'Please input sidebar name and try again.', 'cerax' )."')" );
		...
		if ( isset( $sidebars[ $id ] ) ) {
			...
			die( "alert('".esc_html__( 'Sidebar already exists, please use a different name.', 'cerax' )."')" );
	...
	public static function admin_menu() {
		...
		add_theme_page( esc_html__( 'Sidebars Manager', 'cerax' ), esc_html__( 'Sidebars Manager', 'cerax' ), 'manage_options', 'multiple_sidebars', array( 'sidebar_manager', 'admin_page' ) );
	...
	public static function admin_page() {
		...
		<script>
			...
			function remove_sidebar_name(elem,name){
				...
				answer = confirm("<?php echo esc_html__( 'Are you sure you want to remove', 'cerax' ); ?> " + name + "?\n<?php echo esc_html__( 'This will remove any widgets you have assigned to this sidebar.', 'cerax' ); ?>");
			...
			function add_sidebar_name(){
				...
				var sidebar_name = prompt("<?php echo esc_html__( 'Sidebar Name:', 'cerax' ); ?>","");
		...
		<div class="wrap">
			...
			<h2><?php echo esc_html__( 'Sidebar Generator', 'cerax' ); ?></h2>

			<p>

				<?php echo esc_html__( 'The sidebar name is for your use only. It will not be visible to any of your visitors. A CSS class is assigned to each of your sidebar, use this styling to customize the sidebars.', 'cerax' ); ?>
			...
			<div class="add_sidebar">
				...
				<a href="<?php echo esc_js( 'javascript:void(0)' ); ?>" onclick="return add_sidebar_name()" title="<?php echo esc_html( 'Add a sidebar', 'cerax' ); ?>" class="button-primary"><?php echo esc_html__( '+ Add Sidebar', 'cerax' ); ?></a>
			...
			<table class="widefat page" id="themesflat_table" >
				...
				<tr>
					...
					<th><?php echo esc_html__( 'Name', 'cerax' ); ?></th>

					<th><?php echo esc_html__( 'CSS class', 'cerax' ); ?></th>

					<th><?php echo esc_html__( 'Remove', 'cerax' ); ?></th>
				...
				if ( is_array( $sidebars ) && ! empty( $sidebars ) ) {
					...
					foreach ( $sidebars as $sidebar ) {
						...
						<tr class="<?php echo esc_attr( $alt ); ?>">
							...
							<td><a href="<?php echo esc_js( 'javascript:void(0)' ); ?>" onclick="return remove_sidebar_name(this,'<?php echo esc_attr( $sidebar ); ?>');" title="<?php echo esc_html( 'Remove this sidebar', 'cerax' ); ?>"><?php echo esc_html__( 'remove', 'cerax' ); ?></a></td>
					...
					<tr id="themesflat_noexist">
						...
						<td colspan="3"><?php echo esc_html__( 'No Sidebars defined', 'cerax' ); ?></td>
	...
	public static function edit_form() {
		...
		<div id='themesflat-sortables' class='meta-box-sortables'>
			...
			<div id="themesflat_box" class="postbox " >
				...
				<div class="handlediv" title="Click to toggle"><br /></div><h3 class='hndle'><span><?php echo esc_html__( 'Sidebars', 'cerax' ); ?></span></h3>
				...
				<div class="inside">
					...
					<div class="themesflat_container">
						...
						<p><?php echo esc_html__( 'Please select the sidebar you would like to display.', 'cerax' ); ?> <strong><?php echo esc_html__( 'Note:', 'cerax' ); ?></strong> <?php echo esc_html__( 'You must first create the sidebar under', 'cerax' ); ?> <strong><?php echo esc_html__( 'Appearance > Sidebars', 'cerax' ); ?></strong>.
