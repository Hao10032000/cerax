            ...
            <div class="col-md-12">
                ...
                <div class="social-share-article share-absolute ">
		            	...
		            	<?php 
		            		...
		            		if( themesflat_get_opt('show_social_share') == 1 ):
		            			...
		            			<h5><?php echo esc_html__( 'Share:', 'cerax' ); ?></h5>        
                ...
                <div class="content-post-sigle-title">
                    ...
                    <?php 
                        ...
                        echo '<div class=" post-categories">'.esc_html__("",'cerax');
                ...
                <div class="content-post-single">
		            ...
		            <div class="meta">
		            	...
		            	<?php 
                            ...
                            echo '<i class="meta-icon icon-cerax-date" aria-hidden="true"></i><a class="meta-text" href="'.get_day_link( $archive_year, $archive_month, $archive_day).'">'.get_the_date().'</a>';
                            ...
                            '<i class="meta-icon icon-cerax-user" aria-hidden="true"></i><a class="meta-text" href="%s" title="%s" rel="author">by: %s</a>',
