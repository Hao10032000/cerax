...
function themesflat_setup() {
     ...
     * to change 'cerax' to the name of your theme in all the template files

     */

    load_theme_textdomain( 'cerax', THEMESFLAT_DIR . '/languages' );
    ...
    register_nav_menus( array(
        ...
        'primary' => esc_html__( 'Primary Menu', 'cerax' ),

        'bottom' => esc_html__( 'Bottom Menu', 'cerax' )
...
function themesflat_widgets_init() {
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Sidebar Blog', 'cerax' ),

        'id'            => 'blog-sidebar',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Footer Widget Area 1', 'cerax' ),

        'id'            => 'footer-1',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 1.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Footer Widget Area 2', 'cerax' ),

        'id'            => 'footer-2',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 2.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Footer Widget Area 3', 'cerax' ),

        'id'            => 'footer-3',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 3.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Footer Widget Area 4', 'cerax' ),

        'id'            => 'footer-4',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer widget area 4.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Sidebar Toggler', 'cerax' ),

        'id'            => 'aside-toggler-sidebar',

        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'cerax' ),
    ...
    register_sidebar( array(
        ...
        'name'          => esc_html__( 'Services Sidebar', 'cerax' ),
...
function themesflat_scripts() {    
    ...
    wp_enqueue_style( 'icon-cerax', THEMESFLAT_LINK . 'css/icon-cerax.css' );

    wp_enqueue_style( 'icon-cerax1', THEMESFLAT_LINK . 'css/icon-cerax1.css' );
...
function cerax_elementor_setup() {
...
add_action( 'after_switch_theme', 'cerax_elementor_setup' );
