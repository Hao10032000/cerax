!(function (a) {
        ...
        n = function () {
            ...
            e.on("click", function (e) {
                ...
                a(".modal-menu__body #mainnav-secondary .menu li").each(function (e) {
                    ...
                    0 == a(".modal-menu__body #mainnav-secondary .menu li:has(ul)").find(">span").length && a(".modal-menu__body #mainnav-secondary .menu li:has(ul)").append('<span class="icon-cerax-ona-38"></span>'),
        ...
        o = function () {
            ...
            if (a("body").hasClass("header_sticky")) {
                ...
                var e = a(".hd-sticky"),
                    ...
                    n = a(".hd-sticky").height(),

                    t = a("<div />", { height: n }).insertAfter(a(".hd-sticky"));
            ...
            e.length > 0 &&
                ...
                e.each(function () {
                    ...
                    a(this).owlCarousel({
                        ...
                        navText: ['<i class="icon-cerax-arrow-right"></i>', '<i class="icon-cerax-arrow-left1"></i>'],
    ...
    var j = function () {
        var args = { duration: 250 };
        a("footer .title-footer").on("click", function () {
    ...
    a(document).ready(function () {
        a(window).on('scroll', function () {
            ...
            a('.page-title .overlay').css({
                transform: `translate3d(0px, ${scrollTop * 0.5}px , 0px)` // Điều chỉnh tốc độ parallax
            });
        });
    });
    a(window).on('scroll', function () {
